...
import { User, Ticket, CreditCard, Bell, LogOut, Edit, Calendar, Clock, MapPin } from "lucide-react"
...
const bookings = [
  ...
  },
  {
    id: "booking-2",
    movie: "Oppenheimer",
    image: "/placeholder.svg?height=400&width=300&query=oppenheimer movie poster",
    date: "March 10, 2024",
    time: "8:00 PM",
  ...
  },
  {
    id: "booking-3",
    movie: "The Batman",
    image: "/placeholder.svg?height=400&width=300&query=the batman movie poster",
        ...
        <div className="grid md:grid-cols-[250px_1fr] gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 text-center">
              ...
              <Button variant="outline" className="mt-4 w-full border-zinc-700 text-white hover:bg-zinc-800">
                Edit Profile
              </Button>
            </div>
          ...
          <div>
              ...
              <div>
                ...
                <Tabs defaultValue="upcoming">
                  <TabsList className="bg-zinc-900 border border-zinc-800">
                    <TabsTrigger value="upcoming" className="data-[state=active]:bg-[#FC174D] data-[state=active]:text-white">
                      Upcoming
                    </TabsTrigger>
                    <TabsTrigger value="past" className="data-[state=active]:bg-[#FC174D] data-[state=active]:text-white">
                      Past
                    </TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="upcoming" className="mt-6">
                    <div className="space-y-4">
                      {bookings.filter(booking => booking.status === "upcoming").map((booking) => (
                        <div key={booking.id} className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
                      ...
                      {bookings.filter(booking => booking.status === "upcoming").length === 0 && (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-400 mb-6">You don't have any upcoming movie bookings.</p>
                          <Button className="bg-[#FC174D] hover:bg-[#d91341] text-white">
            ...
            {activeTab === "profile" && (
              <div>
                <h1 className="text-2xl font-bold text-white mb-6">Personal Information</h1>
              ...
              <div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-medium text-white">Saved Cards</h2>
                    <Button className="bg-[#FC174D] hover:bg-[#d91341] text-white">
                      Add New Card
                    </Button>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border border-zinc-800 rounded-lg p-4 flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="font-medium text-white">Mastercard ending in 8888</div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">Receive emails about your bookings and account</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">Receive text messages about your bookings</p>
                      </div>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-zinc-700">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">Receive emails about promotions and new releases</p>
                      </div>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-zinc-700">
                        <span className="absolute inset-0 rounded-full bg-zinc-700"></span>
                        <span className="absolute inset-y-0 left-1 flex h-full items-center justify-center">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">Receive our weekly newsletter</p>
                      </div>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-zinc-700">
                        <span className="absolute inset-0 rounded-full bg-[#FC174D]"></span>
                        <span className="absolute inset-y-0 right-1 flex h-full items-center justify-center">
